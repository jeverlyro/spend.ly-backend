      ...
      const mailOptions = {
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
            ...
            <div style="padding: 20px; background-color: #f9fafb; border-radius: 8px; margin-bottom: 20px;">
              <h3 style="color: #111827; margin-top: 0;">Halo, ${name}!</h3>
              <p style="color: #4b5563; font-size: 15px;">Kami menerima permintaan untuk mengatur ulang kata sandi Anda. Klik tombol di bawah untuk membuat kata sandi baru:</p>
              
              <div style="text-align: center; margin: 30px 0;">
                <a href="${resetUrl}" style="display: inline-block; padding: 12px 24px; background-color: #0070f3; color: white; text-decoration: none; border-radius: 6px; font-weight: 500;">Reset Kata Sandi</a>
              </div>
              
              <p style="color: #4b5563; font-size: 14px;">Link ini akan kedaluwarsa dalam 1 jam.</p>
              <p style="color: #4b5563; font-size: 14px;">Jika Anda tidak meminta reset kata sandi, abaikan email ini.</p>
            </div>
      ...
      const mailOptions = {
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
            ...
            <div style="padding: 20px; background-color: #f9fafb; border-radius: 8px; margin-bottom: 20px;">
              <h3 style="color: #111827; margin-top: 0;">Halo, ${name}!</h3>
              <p style="color: #4b5563; font-size: 15px;">Kata sandi akun Spend.ly Anda telah berhasil diubah.</p>
              <p style="color: #4b5563; font-size: 15px;">Jika Anda tidak melakukan perubahan ini, silakan hubungi kami segera.</p>
            </div>
